class ImageUploadersController < ApplicationController
  ...
  def create
    ...
    @image_uploader.avatar_image.attach(params[:avatar_image])
    respond_to do |format|
      if @image_uploader.save
        format.html { redirect_to @image_uploader, notice: 'Image uploader was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @image_uploader.update(image_uploader_params)
        format.html { redirect_to @image_uploader, notice: 'Image uploader was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to image_uploaders_url, notice: 'Image uploader was successfully destroyed.' }
  ...
  private
    ...
    def image_uploader_params
      params.require(:image_uploader).permit(:name, :email, :avtar, :avatar_image)
    end
end
